...
public class Config {
	...
	static public Map<String,HashSet<Cluster>> Index_table=new HashMap<String,HashSet<Cluster>>();  //索引表
	...
	//信息保存地址
	public static String spo_store_filePath=root_path+"Database_"+database+"//Data//spo_dataset.txt";//spo三元组存储地址	
	public static String hashmap_store_filePath=root_path+"Database_"+database+"//Data";//节点密度数据存储地址
	public static String ClusterCsvFilePath=root_path+"Database_"+database+"//Data//cluster.csv";//集群信息
	public static String NodecsvFilePath=root_path+"Database_"+database+"//Data//node.csv";//节点信息
	public static String Index_tablePath=root_path+"Database_"+database+"//Cluster//Index_table.txt";//索引表
